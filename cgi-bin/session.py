...
session = os.environ.get("SESSION_ID", "<sem sessao>")
visits = os.environ.get("SESSION_VISITS", "0")
cookie = os.environ.get("HTTP_COOKIE", "<o navegador ainda nao devolveu o cookie>")
